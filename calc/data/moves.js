...
var DPP = (0, util_1.extend)(true, {}, DPP_old, DPP_VGC_PATCH);
var BW_PATCH = {
...
var BLACK_DAIZO_PATCH = {
    ...
    'Fire Spin': { bp: 45 },
    'Fissure': { bp: 120 },
    'Frenzy Plant': { recoil: [1, 2] },
    'Fury Attack': { type: 'Flying', bp: 25 },
    'Fury Cutter': { bp: 30 },
    'Fury Swipes': { bp: 25 },
    'Future Sight': { bp: 135 },
    'Gastro Acid': { bp: 40, category: 'Physical' },
    'Giga Impact': { recoil: [1, 2] },
    'Grass Pledge': { bp: 65 },
    'Guillotine': { type: 'Steel', bp: 120 },
    'Gust': { target: 'allAdjacentFoes' },
    'Heat Wave': { bp: 90 },
    'Horn Drill': { bp: 100, type: 'Ground' },
    'Hurricane': { bp: 110 },
    ...
    'Leech Life': { bp: 80 },
    'Lick': { bp: 55 },
    'Magnet Bomb': { category: 'Special' },
    'Mega Kick': { type: 'Fighting' },
    'Mega Punch': { type: 'Fighting', bp: 85 },
    'Mud-Slap': { bp: 30 },
    'Natural Gift': { bp: 60, type: 'Grass' },
    'Needle Arm': { bp: 85 },
    'Overheat': { bp: 130 },
    'Peck': { bp: 50 },
    'Pin Missile': { bp: 25 },
    ...
    'Rock Smash': { bp: 50 },
    'Rock Wrecker': { recoil: [1, 2] },
    'Sand Tomb': { bp: 45 },
    'Sheer Cold': { bp: 130, self: { boosts: { spa: -2 } } },
    'Signal Beam': { bp: 80 },
    'Sky Drop': { bp: 90 },
    'Sludge': { target: 'allAdjacentFoes' },
    'Smack Down': { bp: 60 },
    'Smog': { bp: 35, target: 'allAdjacentFoes' },
    'Snore': { bp: 50 },
    ...
    'Thunder Fang': { bp: 70 },
    'Tri Attack': { bp: 30, multihit: [3, 3] },
    'Triple Kick': { bp: 20 },
    'Twineedle': { bp: 35 },
    'Vice Grip': { type: 'Steel' },
    'Vine Whip': { bp: 45 },
    'Water Pledge': { bp: 65 },
    'Whirlpool': { bp: 45 },
    'Wild Charge': { bp: 95 },
...
var BW = (0, util_1.extend)(true, {}, BW_old, BLACK_DAIZO_PATCH);
delete BW_old['Faint Attack'];
var XY_PATCH = {
...
var XY = (0, util_1.extend)(true, {}, BW_old, XY_PATCH);
var SM_PATCH = {
...
var SS_old = (0, util_1.extend)(true, {}, SM, SS_PATCH);
var GG_PATCH = {
    "Pound": {
        "bp": 40,
        "type": "Normal",
...
var SV_old = (0, util_1.extend)(true, {}, SS_old, SV_PATCH);
var VGC_PLAT_SHOWDOWN_PATCH = {
    "Explosion": { bp: 375 },
